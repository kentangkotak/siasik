...
<div class="col-md-12 col-sm-12 col-xs-12">
   <form name="form_rinci" id="form_rinci" class="form-horizontal form-label-left" onSubmit="return false;">
		...
		<input type="hidden" name="uraianrek50" id="uraianrek50" />
		...
		<div class="form-group col-md-3 col-xs-3 col-sm-3 col-lg-3">
            <label class="control-label">KODE REKENING MAPPING KE 108</label>
            <input type="text" class="form-control" name="koderek108" id="koderek108" />
        </div>
		<div class="form-group col-md-6 col-xs-6 col-sm-6 col-lg-6">
		...
		<div class="form-group col-md-3 col-xs-3 col-sm-3 col-lg-3">
            ...
            <input type="text" class="form-control" name="jumlahacc" id="jumlahacc" onblur="angka(this);" onkeyup="angka(this);"/>
        </div>
