						...
						<tbody>
							...
							<tr class="p-3 mb-2 bg-danger text-white" valign="top";>
								...
								$sql2x=$conn->query("select kode,uraian,sum(anggaran) as anggaranx,sum(realisasi)-sum(kurangi) as realisasix from(
															   ...
															   and penyesesuaianperioritas_heder.kodebidang='".$_GET['kodebidang']."'
															   union all
															   ...
															   where npkls_heder.nopencairan=npkls_rinci.nopencairan and npdls_heder.nonpdls=npkls_heder.nonpdls
															   and npkls_heder.tglpencairan >='".$tgl."' and npkls_heder.tglpencairan <='".$tglx."'
															   and npdls_heder.kodebidang='".$_GET['kodebidang']."'
															   union all
															   select '' as kode,'' as uraian,'' as anggaran,sum(spjpanjar_rinci.jumlahbelanjapanjar) as realisasi,'' as kurangi
															   from spjpanjar_heder,spjpanjar_rinci,mappingpptkkegiatan
															   where spjpanjar_heder.nospjpanjar=spjpanjar_rinci.nospjpanjar and spjpanjar_heder.verif=1
															   and mappingpptkkegiatan.kodepptk=spjpanjar_heder.kodepptk
															   and spjpanjar_heder.tglspjpanjar >='".$tgl."' and spjpanjar_heder.tglspjpanjar <='".$tglx."'
															   and mappingpptkkegiatan.kodebidang='".$_GET['kodebidang']."'
															   union all
															   select '' as kode,'' as uraian,'' as anggaran,'' as realisasi,contrapost.nominalcontrapost as kurangi
															   from contrapost,mappingpptkkegiatan
															   where contrapost.tglcontrapost >='".$tgl."' and contrapost.tglcontrapost<='".$tglx."' and
															   contrapost.kodepptk=mappingpptkkegiatan.kodepptk and
															   mappingpptkkegiatan.kodebidang='".$_GET['kodebidang']."'
															   group by contrapost.kodepptk,contrapost.nocontrapost
													) as xxx");
								...
								<tr>
									...
									<td align="right"><b><?php echo rpzx($rs2x->anggaranx); ?></b></td>
									<td align="right"><b><?php echo rpzx($rs2x->realisasix); ?></b></td>
									<td align="right"><b><?php $selisih=$rs2x->anggaranx-$rs2x->realisasix; echo rpzx($selisih); ?></b></td>
									<td align="right"><b><?php if($rs6->anggaran == 0){ echo 0;}else{$selisihpersen=$rs2x->realisasix/$rs2x->anggaranx*100;echo round($selisihpersen,2);}?>%</b></td>
								</tr>
								<?php
								$sql3x=$conn->query("select kode,uraian,sum(anggaran) as anggaranx,sum(realisasi)-sum(kurangi) as realisasix from(
													   ...
													   and SUBSTRING_INDEX(t_tampung.koderek50,'.',1)='".$rs2x->kode."' and penyesesuaianperioritas_heder.kodebidang='".$_GET['kodebidang']."' 
													   ...
													   from npkls_rinci,npkls_heder,npdls_rinci,npdls_heder
													   where npkls_heder.nopencairan=npkls_rinci.nopencairan and npdls_rinci.nonpdls=npkls_rinci.nonpdls 
													   and npdls_heder.nonpdls=npkls_heder.nonpdls
													   and npkls_heder.tglpencairan >='".$tgl."' and npkls_heder.tglpencairan <='".$tglx."'
													   and SUBSTRING_INDEX(npdls_rinci.koderek50,'.',1)='".$rs2x->kode."' and npdls_heder.kodebidang='".$_GET['kodebidang']."'
													   ...
													   from spjpanjar_rinci,spjpanjar_heder,mappingpptkkegiatan
													   ...
													   from contrapost
													   where tglcontrapost >='".$tgl."' and tglcontrapost <='".$tglx."' and
									...
									<tr>
										...
										<td align="right"><b><?php echo rpzx($rs3x->anggaranx); ?></b></td>
										<td align="right"><b><?php echo rpzx($rs3x->realisasix); ?></b></td>
										<td align="right"><b><?php $selisih=$rs3x->anggaranx-$rs3x->realisasix; echo rpzx($selisih); ?></b></td>
										<td align="right"><b><?php $selisihpersen=($rs3x->realisasix/$rs3x->anggaranx)*100; echo round($selisihpersen,2) ;?>%</b></td>
											...
											$sql4x=$conn->query("select kode,uraian,sum(anggaran) as anggaranx,sum(realisasi)-sum(kurangi) as realisasix from(
																   ...
																   from penyesesuaianperioritas_heder,t_tampung
																   where penyesesuaianperioritas_heder.notrans=t_tampung.notrans and year(penyesesuaianperioritas_heder.tgltrans)='".$thn."'
																   and SUBSTRING_INDEX(t_tampung.koderek50,'.',2)='".$rs3x->kode."' and penyesesuaianperioritas_heder.kodebidang='".$_GET['kodebidang']."' 
																   ...
																   and npdls_heder.nonpdls=npkls_heder.nonpdls
																   and npkls_heder.tglpencairan >='".$tgl."' and npkls_heder.tglpencairan <='".$tglx."'
																   and SUBSTRING_INDEX(npdls_rinci.koderek50,'.',2)='".$rs3x->kode."' and npdls_heder.kodebidang='".$_GET['kodebidang']."'
										...
										<tr>
											...
											<td align="right"><b><?php echo rpzx($rs4x->anggaranx); ?></b></td>
											<td align="right"><b><?php echo rpzx($rs4x->realisasix); ?></b></td>
											<td align="right"><b><?php $selisih=$rs4x->anggaranx-$rs4x->realisasix; echo rpzx($selisih); ?></b></td>
											...
											$sql5x=$conn->query("select kode,uraian,sum(anggaran) as anggaranx,sum(realisasi)-sum(kurangi) as realisasix from(
																   ...
																   from penyesesuaianperioritas_heder,t_tampung
																   where penyesesuaianperioritas_heder.notrans=t_tampung.notrans and year(penyesesuaianperioritas_heder.tgltrans)='".$thn."'
																   and SUBSTRING_INDEX(t_tampung.koderek50,'.',3)='".$rs4x->kode."' and penyesesuaianperioritas_heder.kodebidang='".$_GET['kodebidang']."' 
																   ...
																   and npdls_heder.nonpdls=npkls_heder.nonpdls
																   and npkls_heder.tglpencairan >='".$tgl."' and npkls_heder.tglpencairan <='".$tglx."'
																   and SUBSTRING_INDEX(npdls_rinci.koderek50,'.',3)='".$rs4x->kode."' and npdls_heder.kodebidang='".$_GET['kodebidang']."'
											...
											<tr>
												...
												<td align="right"><?php echo rpzx($rs5x->anggaranx); ?></td>
												<td align="right"><?php echo rpzx($rs5x->realisasix); ?></td>
												<td align="right"><?php $selisih=$rs5x->anggaranx-$rs5x->realisasix; echo rpzx($selisih); ?></td>
												...
												$sql6x=$conn->query("select kode,uraian,sum(anggaran) as anggaranx,sum(realisasi)-sum(kurangi) as realisasix from(
																	   ...
																	   from penyesesuaianperioritas_heder,t_tampung
																	   where penyesesuaianperioritas_heder.notrans=t_tampung.notrans and year(penyesesuaianperioritas_heder.tgltrans)='".$thn."'
																	   and SUBSTRING_INDEX(t_tampung.koderek50,'.',4)='".$rs5x->kode."' and penyesesuaianperioritas_heder.kodebidang='".$_GET['kodebidang']."' group by SUBSTRING_INDEX(t_tampung.koderek50,'.',5)
																	   union all
																	   ...
																	   and npdls_heder.nonpdls=npkls_heder.nonpdls
																	   and npkls_heder.tglpencairan >='".$tgl."' and npkls_heder.tglpencairan <='".$tglx."'
																	   and SUBSTRING_INDEX(npdls_rinci.koderek50,'.',4)='".$rs5x->kode."' and npdls_heder.kodebidang='".$_GET['kodebidang']."'
												...
												<tr>
													...
													<td align="right"><?php echo rpzx($rs6x->anggaranx); ?></td>
													<td align="right"><?php echo rpzx($rs6x->realisasix); ?></td>
													<td align="right"><?php $selisih=$rs6x->anggaranx-$rs6x->realisasix; echo rpzx($selisih); ?></td>
													...
													$sql7x=$conn->query("select kode,uraian,sum(anggaran) as anggaranx,sum(realisasi)-sum(kurangi) as realisasix from(
																		   ...
																		   where penyesesuaianperioritas_heder.notrans=t_tampung.notrans 
																		   and year(penyesesuaianperioritas_heder.tgltrans)='".$thn."'
																		   and SUBSTRING_INDEX(t_tampung.koderek50,'.',5)='".$rs6x->kode."' and penyesesuaianperioritas_heder.kodebidang='".$_GET['kodebidang']."' group by SUBSTRING_INDEX(t_tampung.koderek50,'.',6)
																		   union all
																		   ...
																		   and npdls_heder.nonpdls=npkls_heder.nonpdls
																		   and npkls_heder.tglpencairan >='".$tgl."' and npkls_heder.tglpencairan <='".$tglx."'
																		   and SUBSTRING_INDEX(npdls_rinci.koderek50,'.',5)='".$rs6x->kode."' and npdls_heder.kodebidang='".$_GET['kodebidang']."'
																		   ...
																		   and spjpanjar_heder.tglspjpanjar >='".$tgl."' and spjpanjar_heder.tglspjpanjar <='".$tglx."' 
																		   and mappingpptkkegiatan.kodebidang='".$_GET['kodebidang']."'
																		   and SUBSTRING_INDEX(spjpanjar_rinci.koderek50,'.',5)='".$rs6x->kode."' 
																		   ...
																		   from contrapost
																		   where year(tglcontrapost)>='".$tgl."' and year(tglcontrapost)<='".$tglx."' and
																		   SUBSTRING_INDEX(koderek50,'.',5)='".$rs5x->kode."' and kodekegiatanblud='".$_GET['kodekegiatanblud']."'
													...
													<tr>
														...
														<td align="right"><?php echo rpzx($rs7x->anggaranx); ?></td>
														<td align="right"><?php echo rpzx($rs7x->realisasix); ?></td>
														<td align="right"><?php $selisih=$rs7x->anggaranx-$rs7x->realisasix; echo rpzx($selisih); ?></td>
								...
								<tr class="p-3 mb-2 bg-danger text-white" valign="top";>
									<td colspan="2" align="right"><b>JUMLAH</b></td>
									<td align="right"><b><?php echo rpzx($totalanggaranperkegiatan); ?></b></td>
									<td align="right"><b><?php echo rpzx($rs2x->realisasix); ?></b></td>
									<td align="right"><b><?php echo rpzx($selisihTotal=$totalanggaranperkegiatan-$rs2x->realisasix); ?><b></td>
