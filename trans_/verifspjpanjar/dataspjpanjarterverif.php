...
<?php
	...
	$sql=$conn->query("select spjpanjar_heder.nospjpanjar as nospjpanjar,spjpanjar_heder.tglspjpanjar as tglspjpanjar,spjpanjar_heder.notapanjar as notapanjar,spjpanjar_heder.namapptk as pptk,
						...
						and spjpanjar_heder.kunci='1' and spjpanjar_heder.verif='1'
...
<table class="table table-hover table-bordered table table-striped" id="dataTables-example">
		...
		<tbody>
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td align="center"><a href="javascript:void(0)"; onClick="viewdetail('<?php echo $rs->nospjpanjar; ?>');"><?php echo $rs->nospjpanjar; ?></a></td>
