...
<?php
	...
	$sql=$conn->query("select notrans,tanggal,kode50,keterangan,awal,sum(masuk) as masukx,sum(keluar) as keluarx,urut from(
		   select notapanjar_rinci.nonotapanjar as notrans,notapanjar_heder.tglnotapanjar as tanggal,notapanjar_heder.pptk as namapptk,
           notapanjar_rinci.koderek50 as kode50,
		   notapanjar_rinci.rincianbelanja50 as keterangan,'' as awal,notapanjar_rinci.total as masuk,'' as keluar,1 as urut
		   ...
		   pengembaliansisapanjar_heder.pptk as namapptk,pengembaliansisapanjar_rinci.koderek50 as kode50,
		   ...
		   pengembalianpanjar_heder.pptk as namapptk,pengembalianpanjar_rinci.koderek50 as kode50,
    ...
    <div class="x_panel">
      <div class="x_title">
        <center>BADAN LAYANAN UMUM DAERAH <?php echo  $rs1->nama;?></br>
				LAPORAN BUKU BANTU KAS PPTK </br>
