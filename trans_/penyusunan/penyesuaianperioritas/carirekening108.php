...
<?php
    ...
    $sql=$conn->query("select concat_ws('.', kode1, kode2, kode3, kode4 , kode5, kode6, kode7) as kode,uraian 
...
<table class="table table-hover table-bordered table table-striped" id="dataTables-example">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<input type="button" value="PILIH" onclick="pilihrekening108('<?php echo $rs->kode;?>','<?php echo str_replace(array("\n", "\r"), '', $rs->uraian);?>')">
			</td>
		</tr>
		<?php $i++; } ?>
	</tbody>
...
<script>
	function cariusulan(){
		...
		$.get('trans_/penyusunan/penyesuaianperioritas/carirekening108.php',{
			usulantxt:usulantxt,
		},
		function(rs){
