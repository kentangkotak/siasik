...
<table class="table table-hover table-bordered table table-striped" id="dataTables-example">
	...
	<tbody>
		...
		<tr>
			...
			<td><input type="button" value="PILIH" onclick="pilihitembelanjanonfarmasi('<?php echo $rs->itembelanja;?>','<?php echo rpz($rs->volume);?>','<?php echo $rs->satuan; ?>',
			...
			'<?php echo $rs->koderek108;?>','<?php echo $rs->uraian108;?>','1');"></td>
		</tr>
		<?php $i++; } ?>
	</tbody>
</table>	
