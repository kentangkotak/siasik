...
<?php
	...
	$sql=$conn->query("
		select 
			...
			kode6,
			kode7 kode7x,
			concat(kode1,'.',kode2,'.',kode3,'.',kode4,'.',kode5,'.',kode6,'.',kode7) kode7,	concat(blud_akun,'.',blud_kelompok,'.',blud_jenis,'.',blud_objectx,'.',blud_rincian,'.',blud_subrincian) kode_blud,
			blud_uraian
		from 
			akun_permendagri108
		where 
...
<table class="table table-hover table-bordered table table-striped" id="dataTables-example">
		...
		<tbody>
			...
			<tr>	
				...
				<td><?php echo $rs->kode_blud; ?></td>
				<td><?php echo $rs->blud_uraian; ?></td>
				<td></td>
			</tr>
			<?php
				$i++;
