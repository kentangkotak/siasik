...
/* 	jfloading("sub_konten");
	$.get("master_folder/akun_permendagri50/form.php",
		{
			kode:kode
		},
		function(result){
...
function list(){
	jfloading("sub_konten");
	$.get("master_folder/akun_permendagri50/list.php",
		function(result){ 
			$("#sub_konten").html(result);
			jfdata_table(); 
		}
...
function simpan(){  
	...
	if(nomenklatur==''){
		...
		$.get("master_folder/akun_permendagri50/simpan.php",
		{
			no:no,
...
function hapus(id){
	...
	function(isConfirm){
		if(isConfirm==true){
			$.get("master_folder/akun_permendagri50/hapus.php",{id:id},
				function(result){ 
					if(result=="OK"){
...
function list_kode2(kode1){
	jfloading("sub_konten");
	$.get("master_folder/akun_permendagri50/list_kode2.php",
		{
			kode1:kode1
		},
		function(result){
...
function list_kode3(kode2){
	jfloading("sub_konten");
	$.get("master_folder/akun_permendagri50/list_kode3.php",
		{
			kode2:kode2
		},
		function(result){ 
...
function list_kode4(kode3){
	jfloading("sub_konten");
	$.get("master_folder/akun_permendagri50/list_kode4.php",
		{
			kode3:kode3
		},
		function(result){ 
...
function list_kode5(kode4){
	jfloading("sub_konten");
	$.get("master_folder/akun_permendagri50/list_kode5.php",
		{
			kode4:kode4
		},
		function(result){ 
...
function list_kode6(kode5){
	jfloading("sub_konten");
	$.get("master_folder/akun_permendagri50/list_kode6.php",
		{
			kode5:kode5
		},
		function(result){ 
