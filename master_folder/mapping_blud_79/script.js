function data_akun_blud(){  
	...
	$.get("master_folder/mapping_blud_79/akunblud.php",
		function(result){ 
...
function tingkat2(akun){ 
	jfloading("sub_konten");
	$.get("master_folder/mapping_blud_79/akunblud2.php",{akun:akun},
		function(result){ 
			$("#sub_konten").html(result);
			jfdata_table(); 
		}
...
function tingkat3(akun,kelompok){
	jfloading("sub_konten");
	$.get("master_folder/mapping_blud_79/akunblud3.php",{akun:akun,kelompok:kelompok},
		function(result){ 
			$("#sub_konten").html(result);
			jfdata_table(); 
		}
...
function tingkat4(akun,kelompok,jenis){
	jfloading("sub_konten");
	$.get("master_folder/mapping_blud_79/akunblud4.php",{akun:akun,kelompok:kelompok,jenis:jenis},
		function(result){ 
			$("#sub_konten").html(result);
			jfdata_table(); 
		}
...
function tingkat5(akun,kelompok,jenis,objectx){
	jfloading("sub_konten");
	$.get("master_folder/mapping_blud_79/akunblud5.php",{akun:akun,kelompok:kelompok,jenis:jenis,objectx:objectx},
		function(result){ 
			$("#sub_konten").html(result);
			jfdata_table(); 
		}
...
function tingkat6(akun,kelompok,jenis,objectx,rincian){
	jfloading("sub_konten");
	$.get("master_folder/mapping_blud_79/akunblud6.php",{akun:akun,kelompok:kelompok,jenis:jenis,objectx:objectx,rincian:rincian},
		function(result){ 
			$("#sub_konten").html(result);
			jfdata_table(); 
		}
...
function tingkat7(akun,kelompok,jenis,objectx,rincian,subrincian){
	jfloading("sub_konten");
	$.get("master_folder/mapping_blud_79/akunblud7.php",{akun:akun,kelompok:kelompok,jenis:jenis,objectx:objectx,rincian:rincian,subrincian:subrincian},
		function(result){ 
			$("#sub_konten").html(result);
			jfdata_table(); 
		}
...
function simpan_mapping(){ 
	...
	if(kode_791==''){
		...
		$.get("master_folder/mapping_blud_79/simpan_mapping.php",get_param,
		function(result){ 
...
function mapping(akun,kelompok,jenis,objectx,rincian,subrincian){
	jfloading("sub_konten");
	$.get("master_folder/mapping_blud_79/mapping.php",{akun:akun,kelompok:kelompok,jenis:jenis,objectx:objectx,rincian:rincian,subrincian:subrincian},
		function(result){ 
			$("#sub_konten").html(result);
			ac_uraian79(); 
		}
