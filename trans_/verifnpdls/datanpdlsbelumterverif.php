...
if($_SESSION["anggaran_koderuangan"]==''){
	$sql=$conn->query("select npdls_heder.nonpdls as nonpdls,npdls_heder.tglnpdls as tglnpdls,npdls_heder.pptk as namapptk,npdls_heder.triwulan as triwulan,npdls_heder.program as program,npdls_heder.keterangan as keterangan,
						...
						where year(npdls_heder.tglnpdls)='".$_SESSION["anggaran_tahun"]."' and npdls_heder.kunci=1 and npdls_heder.verif=''
	...
	$sql=$conn->query("select npdls_heder.nonpdls as nonpdls,npdls_heder.tglnpdls as tglnpdls,npdls_heder.pptk as namapptk,npdls_heder.triwulan as triwulan,npdls_heder.program as program,npdls_heder.keterangan as keterangan,
						...
						from npdls_heder left join npdls_rinci 
						on npdls_heder.nonpdls=npdls_rinci.nonpdls
						where year(npdls_heder.tglnpdls)='".$_SESSION["anggaran_tahun"]."' and npdls_heder.kodebidang='".$_SESSION["anggaran_koderuangan"]."' and npdls_heder.kunci=1 and npdls_heder.verif=''
						group by npdls_heder.nonpdls");
}
	$i=1;
?>
...
<table class="table table-hover table-bordered table table-striped" id="dataTables-example">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="javascript:void(0)" onclick="kunci('<?php echo $rs->nonpdls; ?>')" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> VERIFIKASI </a>
				</td>
			</tr>
			<?php
				$i++;
