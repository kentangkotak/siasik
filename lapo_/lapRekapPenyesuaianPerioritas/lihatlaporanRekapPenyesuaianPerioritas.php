...
<?php
		...
		$sql=$conn->query("SELECT bidang,pptk,kegiatan,usulan,volume,harga,total from(
							...
							and year(penyesesuaianperioritas_heder.tgltrans)='".$_GET['thn']."' and penyesesuaianperioritas_heder.namabidang='".$_GET['bidang']."' group by bidang) as wew 
							");

	$i=1;

?>
<a href="javascript:void(0)" onclick="ExportToExcel_laporanRekapPenyesuaianperioritas()"><img src="images/excel.jpg" width="20" height="20">Export to Excel</a>
<div id="excel_repot_laporanRekapPenyesuaianperioritas">
