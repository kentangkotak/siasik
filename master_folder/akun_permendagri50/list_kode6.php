...
<?php
	...
	$sql=$conn->query("
		select 
			...
			concat(kode1,'.',kode2,'.',kode3,'.',kode4) kode4x
		from 
			akun_permendagri50
		where 
			kode1='".$kode1."' 
...
<table class="table table-hover table-bordered table table-striped" id="dataTables-example">
		...
		<tbody>
			...
			<tr>	
				...
				<td>
				<a href="javascript:void(0)" onclick="list_kode5('<?php echo $rs->kode4x; ?>')" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Back </a></td>
			</tr>
			<?php
				$i++;
				}
