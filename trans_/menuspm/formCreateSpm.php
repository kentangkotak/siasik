...
<div class="col-md-12 col-sm-12 col-xs-12">
    <form name="formsppup" id="formsppup" class="form-horizontal form-label-left" onSubmit="return false;">
	<input type="hidden" name="nip" id="nip" value="<?php echo $rs->kdBendaharaKeluar;?>">
        ...
        <div class="form-group col-md-6 col-xs-6 col-sm-6 col-lg-6">
            ...
            <input type="text" class="form-control" name="jumlahspp" id="jumlahspp" readonly="yes" value="<?php echo $rs->jumlahspp;?>"/>
        </div>
		<div class="form-group col-md-6 col-xs-6 col-sm-6 col-lg-6">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		  ...
		  <div class="x_title">
			...
			<form name="form_spm" id="form_spm" class="form-horizontal form-label-left" onSubmit="return false;">
				<div class="col-md-3 col-xs-3 col-sm-3 col-lg-3">
					<label>Nomor SPM</label>
					<input type="text" class="form-control" name="nomorspm" id="nomorspm" readonly="yes"/>
				</div>
				<div class="col-md-3 col-xs-3 col-sm-3 col-lg-3">
					<label>Tanggal Spm</label>
					<input type="text" class="form-control" name="tglspm" id="tglspm" value="<?php echo date('d/m/Y') ;?>" onClick="return getCalendar(document.form_spm.tglspm);"/>
				</div>
				<div class="col-md-3 col-xs-3 col-sm-3 col-lg-3">
					<label>NPWP</label>
				...
				<div class="col-md-3 col-xs-3 col-sm-3 col-lg-3">
					...
					<input type="text" class="form-control" name="uraianpekerjaan" id="uraianpekerjaan"/>
				</div>
				<div class="clearfix"></div>
				<div>
					<label></label>
				...
				<div class="col-md-3 col-xs-3 col-sm-3 col-lg-3">
				   <input type="button" name="tsimpan" class="btn btn-success btn-block" id="tsimpan" value="SIMPAN SPM" onClick="createSpm();">
				</div>
			  </div>
			</form>				
		</div>
