    ...
    $sql=$conn->query("select notrans,kodekegiatan,kegiatanblud,koderek50,uraian50,koderek108,uraian108,usulan,jumlahacc,satuan,harga,total,nousulan,idpp,itembelanja,
						...
						from(
								  ...
								  from(
											...
											'' as usulan,'' as jumlahacc,'' as satuan,'' as harga,'' as total,'' as nousulan,serahterima_rinci.idserahterima_rinci as idpp,'' as itembelanja,serahterima_rinci.totalls as totalpake
											from serahterima_heder,serahterima_rinci
											where serahterima_heder.nokontrak=serahterima_rinci.nokontrak
											) as wew 
								  group by idpp)
...
<table class="table table-hover table-bordered table table-striped" id="dataTables-example">
	...
	<tbody>
		...
		<tr>
			...
			<td><input type="button" value="PILIH" onclick="pilihcariitembelanja('<?php echo $rs->usulan;?>','<?php echo rpz($rs->jumlahacc);?>','<?php echo $rs->satuan; ?>',
