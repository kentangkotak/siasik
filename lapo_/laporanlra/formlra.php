...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<input type="hidden" name="kodekegiatanblud" id="kodekegiatanblud" >
		...
		<div class="form-group col-md-6 col-xs-6 col-sm-6 col-lg-6">
			...
			<a href="javascript:void(0);" onclick="caribagian();"><img src="images/search.gif" border="0" width="13px" /></a>
			<input type="text" class="form-control" name="bidang" id="bidang" readonly="yes"/>
		</div>
		<div class="form-group col-md-6 col-xs-6 col-sm-6 col-lg-6">
			<label class="control-label">KEGIATAN (KOSONGI BILA INGIN TAMPIL SEMUA)</label>
			<a href="javascript:void(0);" onclick="carikegiatan();"><img src="images/search.gif" border="0" width="13px" /></a>
		...
		<div class="form-group col-md-3 col-xs-3 col-sm-3 col-lg-3">
			...
			<input type="button" name="tsimpan" class="btn btn-success btn-block" id="tsimpan" value="LIHAT"  onClick="lihatlra_asli();">
	    </div>
    </form>     
</div>
<div class="x_content">
